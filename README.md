...
is as follows:
    ...
    same calendar month and year as the expected return date, fine = 15 hackos * number 
    of days late.

    3. If the book is returned after the expected return month but still within 
    the same calendar year as the expected return date, the fine = 500 hackos * number 
    of months late.
